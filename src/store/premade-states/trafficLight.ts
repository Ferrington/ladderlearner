...
export const state: Store = {
  ...
  dropLocations: {
    branchdQMpwlu4biMhos6wbTRGt: [0, 1],
    branchyAc19Kvs5REdatdnwPNK4: [0],
    "branch81ZpaF5-N766c7W8WfbMR": [0, 1],
    branchprbBJmwcwcnh8X5Vd45ZV: [0, 1],
    branchECBadh8jirlkJw2rcLW6r: [0, 1],
    branchEmt5FneuuIC2dVb1R92xC: [0, 1],
    "branchmny_-HJ1xB74K4WUgT2Z1": [0],
    "branchdY05qC-BuBEoUFJe2mkKm": [0, 1],
    "branchIAs2rCuSRL9gHWEr-HfCI": [0],
    branchDsmj80FwSLCJKnNPKIKEi: [0, 1],
    "branch75hNQ-Z4fLHN9f6jDJq4Q": [0, 1],
    branchCvdeuJOWLa7N2_JP2eHw4: [0],
    branchppuex6in54EBBze286ax4: [0, 1],
  },
